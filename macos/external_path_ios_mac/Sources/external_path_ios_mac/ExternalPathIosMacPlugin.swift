...
public class ExternalPathIosMacPlugin: NSObject, FlutterPlugin {
  ...
  public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
    ...
    case "getRootInstallationPath":
      let rootPath = getRootInstallationPath()
      result(rootPath)
    default:
  ...
  private func getRootInstallationPath() -> String? {
    // On macOS, return the main bundle path (application installation directory)
