...
abstract class ExternalPathIosMacPlatform extends PlatformInterface {
  ...
  ///
  /// This method must be implemented by platform-specific subclasses to provide the
  /// root installation path. On iOS, this typically returns the application's bundle
  /// path or sandbox root. On macOS, this returns the application's installation directory.
  ///
  /// Returns:
  ///   A [Future] that completes with the root installation path as a [String], or throws
  ///   an [UnimplementedError] if not implemented.
