...
class MethodChannelExternalPathIosMac extends ExternalPathIosMacPlatform {
  ...
  ///
  /// This method invokes the `getRootInstallationPath` method on the native platform
  /// and returns the root installation path as a [String]. On iOS, this typically returns
  /// the application's bundle path or sandbox root. On macOS, this returns the application's
  /// installation directory.
  ///
  /// Returns:
  ///   A [Future] that completes with the root installation path as a [String], or `null` if not available.
  @override
